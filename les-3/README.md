...
2.	Внутри `function fetchCharacters() {}` реализуйте получение данных с [API](https://bravevillainousexponents.dbronskih.repl.co/characters), используя [Fetch](https://learn.javascript.ru/fetch)
